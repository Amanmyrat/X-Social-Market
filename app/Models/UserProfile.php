...
class UserProfile extends BaseModel implements HasMedia
{
    ...
    {
        $this->addMediaConversion('large')->format('webp')->width(1024)->optimize()->performOnCollections('user_images');
        $this->addMediaConversion('medium')->format('webp')->width(768)->optimize()->performOnCollections('user_images');
        $this->addMediaConversion('thumb')->format('webp')->width(100)->blur(1)->optimize()->performOnCollections('user_images');
    }
